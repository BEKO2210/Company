...
export function getToolTitle(toolName: string): string {
  ...
  const toolTitles: Record<string, string> = {
    ...
    'session_list_background': 'Background Sessions',
    'session-list-background': 'Background Sessions',
    'session_list_spawned': 'Spawned Sessions',
    'session-list-spawned': 'Spawned Sessions',
    'session_context': 'Session Context',
    'session-context': 'Session Context',

    // The Company trigger tools (unified `triggers` tool with action param)
    'triggers': 'Triggers',
    'trigger_create': 'Create Trigger',
    'trigger-create': 'Create Trigger',
    'trigger_list': 'List Triggers',
    'trigger-list': 'List Triggers',
    'trigger_get': 'Trigger Details',
    ...
    'trigger-pause': 'Pause Trigger',
    'trigger_resume': 'Resume Trigger',
    'trigger-resume': 'Resume Trigger',

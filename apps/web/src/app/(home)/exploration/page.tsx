...
const stackStudies = [
  {
    ...
    rows: [
      ...
      ['The Company orchestration', 'Memory, integrations, scheduling, tunnels'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['The Company keeps it organized', 'Cron, routing, memory, integrations'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['The Company', 'Routes intent and keeps memory coherent'],
          ...
          <div>
            <Reveal delay={0.03}>
              ...
              <h1 className="mt-4 max-w-4xl text-4xl font-medium tracking-tight text-foreground sm:text-5xl md:text-6xl">
                A calmer way to evaluate how The Company should explain itself.
              </h1>

...
export const metadata: Metadata = {
  ...
  keywords:
    'The Company, about The Company, self-driving company, AI-operated company, autonomous operations, agent workforce, AI agents, company automation',
  openGraph: {
    title: 'About The Company – Building Self-Driving Companies',
    description:

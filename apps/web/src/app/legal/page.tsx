                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        The Company AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        The Company is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/beko2210/company/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/beko2210/company/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All The Company logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE The Company WEB APP AND ANY CONTENT) IS PROVIDED
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at The Company in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        The Company does not collect biometric or identifying
